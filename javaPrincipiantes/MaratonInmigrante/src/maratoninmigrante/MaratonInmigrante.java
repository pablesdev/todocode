/*
En la ciudad de Oberá, Misiones se realiza año a año la Maraton del Inmigrante en el marco de la Fiesta Nacional del Inmigrante. El evento cuenta con un día de inscripciones el día anterior a la carrera, por lo que se desconoce la cantidad exacta de inscriptos que puede llegar a haber. Desdee la Federación de Colectividades (Organismo que organiza), manifestaron que se solicitan los siguientes datos para la inscripción de cada participante: dni, nombre y edad.
...
Se necesita un programa que, a partir del ingreso de los datos y edad de cada participante, se muestre por pantalla a qué categoría debe ser inscripto. Cabe destacar que , al finalizar el día, para dar fin a las Inscripciones, se debe ingresar un dni con el valor 0, y un nombre dom la palabra "fin".
*/
    ...
    public static void main(String[] args) {
        ...
        while((!dni.equals("0")) && (!nombre.equalsIgnoreCase("fin")) ){
            ...
            if(edad>=6 && edad<=10){
                    ...
                    System.out.println("La persona no cuenta con la edad requerida.");
                }
